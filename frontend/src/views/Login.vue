    ...
    <section class="form-section">
      <div class="auth-card">
        ...
        <template v-else-if="authMode === 'login'">
          ...
          <!-- 底部注册链接 -->
          <div class="card-footer" v-if="registrationAllowed">
        ...
        <!-- 注册模式 -->
        <template v-else-if="registrationAllowed">
          <div class="card-header">
...
:global([data-theme="dark"]) .form-section {
  background:
    radial-gradient(circle at 50% 8%, rgba(251, 146, 60, 0.08), transparent 34%),
    var(--bg-base, #111318);
}
