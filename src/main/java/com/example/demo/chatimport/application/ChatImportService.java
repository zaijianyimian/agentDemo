...
import com.example.demo.chatimport.dto.ChatImportResult;
...
public class ChatImportService {
    ...
    public ChatImportService(ChatHistoryAccessService chatHistoryAccessService, ObjectMapper objectMapper) {
    ...
    public ChatImportResult importChatHistory(InputStream inputStream, String platform) {
        try {
            ...
            for (ChatHistory message : messages) {
                chatHistoryAccessService.save(message);
            }
    ...
    public int deleteBySessionId(String sessionId) {
        return chatHistoryAccessService.deleteBySessionId(sessionId);
    }
    ...
    public List<ChatHistory> getSessionMessages(String sessionId) {
        return chatHistoryAccessService.findBySessionId(sessionId);
    }

    /**
     * 获取全部导入会话 ID 列表，可按平台过滤。
     */
    public List<String> getAllSessionIds(String platform) {
        return chatHistoryAccessService.findSessionIds(platform);
    }
}
