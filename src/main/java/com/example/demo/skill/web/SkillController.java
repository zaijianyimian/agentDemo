...
import com.example.demo.skill.dto.SkillExecutionResult;
...
import com.example.demo.skill.application.SkillLoaderService;
import com.example.demo.skill.application.SkillService;
...
public class SkillController {
    ...
    /**
     * 获取所有技能。@Cacheable 已在 Service 层声明，避免双重缓存导致 Recursive update。
     */
    @GetMapping("/list")
