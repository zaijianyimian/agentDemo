...
import com.example.demo.infrastructure.web.WriteEndpointRateLimitInterceptor;
...
/**
 * WebMvc 配置类
 * 配置异步支持、SSE 流式响应、写端点限流拦截器
 */
@Configuration
@RequiredArgsConstructor
public class WebMvcConfig implements WebMvcConfigurer {

    private final WriteEndpointRateLimitInterceptor writeRateLimitInterceptor;
